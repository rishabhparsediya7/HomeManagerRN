...
const FriendItem = ({ id, image, firstName, lastName, lastMessage, lastMessageTime, nonce, styles }: { id: string, image: string, firstName: string, lastName: string, lastMessage: string, lastMessageTime: string, nonce: string, styles: any }) => {
...
const FriendsScreen = ({ friends, loading }: { friends: any, loading: boolean }) => {
    ...
    return (
        <FlatList
            ...
            renderItem={({ item }) => <FriendItem id={item?.friendId} image={item?.image} firstName={item?.firstName} lastName={item?.lastName} lastMessage={item?.lastMessage} lastMessageTime={item?.lastMessageTime} nonce={item?.nonce} styles={styles} />}
